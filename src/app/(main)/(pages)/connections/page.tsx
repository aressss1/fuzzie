...
import { onDiscordConnect } from "./_actions/disocord-connection";
        ...
        <div className="relative flex flex-col gap-4" >
            ...
            <div className="relative flex flex-col gap-4" >
                <section className="flex flex-col gap-4 p-6 text-muted-foreground" >
                    Connects all your apps directly from here. You may need to connect these apps regularly to refresh verification.
